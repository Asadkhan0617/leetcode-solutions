...
class Solution {
    ...
    private TreeNode build(int[] preorder, int preStart, int preEnd, int inStart, int inEnd) {
        ...
        root.left = build(preorder, preStart + 1,preStart + leftTreeSize,inStart,inRootIndex - 1);

        root.right = build(preorder,preStart + leftTreeSize + 1, preEnd,inRootIndex + 1,inEnd);
